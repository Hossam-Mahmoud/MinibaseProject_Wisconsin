  ...
  public static void printPage(PageId pageno, int keyType)
    throws  IOException, 	    
	    ...
	    PageUnpinnedException, 
            InvalidFrameNumberException, InvalidSlotNumberException, KeyNotMatchException, NodeNotMatchException, ConvertException
    {
 ...
 * @throws InvalidSlotNumberException 
   */
  public static void printBTree(BTHeaderPage header) 
    throws IOException, 
	   ConstructPageException, 
	   HashEntryNotFoundException,
	   InvalidFrameNumberException,
	   PageUnpinnedException,
	   ReplacerException, InvalidSlotNumberException, KeyNotMatchException, NodeNotMatchException, ConvertException 
    {
      if(header.getRootId().pid == INVALID_PAGE) {
	...
	return;
      ...
      System.out.println(1+ "     "+header.getRootId());
      
      _printTree(header.getRootId(), "     ", 1, header.getKeyType());
 ...
 * @throws InvalidSlotNumberException 
   */
  public static void printAllLeafPages(BTHeaderPage header) 
    throws IOException, 
	   ConstructPageException, 
	   HashEntryNotFoundException,
	   InvalidFrameNumberException,
	...
	return;
      ...
      _printAllLeafPages(header.getRootId(), header.getKeyType());
